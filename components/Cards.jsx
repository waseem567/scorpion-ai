...
const Cards = () => {
    return <div className="grid md:grid-cols-2 lg:grid-cols-3 justify-center sm:grid-cols-2 max-w-screen-xl mx-auto py-32 gap-5 grid-cols-1 p-5">
        {/* card 1 */}
        <div className="mx-auto  cursor-pointer shadow-sm hover:drop-shadow-2xl transition-all duration-500 p-11 border rounded-lg min-h-[400px] max-w-[380px]">
            <div className="">
            ...
            <div>
            <button className="text-green-600 px-0 mt-5 text-base text-start font-semibold ">READ MORE</button>
        </div>
        </div>
       {/* card 2 */}
       <div className="mx-auto  cursor-pointer shadow-sm hover:drop-shadow-2xl transition-all p-11 border rounded-lg min-h-[400px] max-w-[380px]">
            <div className="">
...
& Matching Text</p>
    ...
    {/* card 3 */}
    <div className="cursor-pointer shadow-sm hover:drop-shadow-2xl transition-all p-11 border mx-auto rounded-lg min-h-[400px] max-w-[380px]">
            <div className="">
